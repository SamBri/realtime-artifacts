	...
	public ResponseEntity<MessagingResponse<MessagePayload>> createMessage(@RequestBody MessagePayloadDTO message) {
		...
		try {
			...
			if (theCreatedMsgPayload != null) {
				...
				createMessageResponse = new ResponseEntity<MessagingResponse<MessagePayload>>(successMessageResponse,
						HttpStatus.OK);
				...
				createMessageResponse = new ResponseEntity<MessagingResponse<MessagePayload>>(errorMessageResponse,
						HttpStatus.OK);
			}
	...
	public ResponseEntity<MessagingResponse<List<MessagePayload>>> getAllMessages() {
		...
		try {
			...
			if (list != null) {
				...
				allMessagesResponse = new ResponseEntity<MessagingResponse<List<MessagePayload>>>(
						successMessageResponse, HttpStatus.OK);
				...
				allMessagesResponse = new ResponseEntity<MessagingResponse<List<MessagePayload>>>(errorMessageResponse,
						HttpStatus.OK);
			}
	...
	public ResponseEntity<MessagingResponse<List<MessagePayload>>> getAllMessagesByUserId(@PathVariable UUID userId) {
		...
		try {
			...
			if (list != null) {
				...
				allMessagesByUserIdResponse = new ResponseEntity<MessagingResponse<List<MessagePayload>>>(
						successMessageResponse, HttpStatus.OK);
				...
				allMessagesByUserIdResponse = new ResponseEntity<MessagingResponse<List<MessagePayload>>>(
						errorMessageResponse, HttpStatus.OK);
			}
